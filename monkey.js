(function(global){
    ...
    var Promote = function(a, d){
        ...
        self.merge = function(){
            ...
            if(arguments.length>1){
                ...
                if(Array.prototype.isPrototypeOf(args[0]) && Array.prototype.isPrototypeOf(args[1])){
                    if(args.length>2){
            ...
            return Array.prototype.merge.apply(a, args);
        };
    ...
    Array.prototype._columns = undefined;

    Array.prototype.columns = function(cols){
        var proto = Object.getPrototypeOf(this);
        if(cols===undefined){
            //if(proto._columns===undefined){
            proto._columns = [];
    ...
    Array.prototype.orderby = function(col){
    ...
    Array.prototype.min = function(c){
    ...
    Array.prototype.avg = function(c){
    ...
    Array.prototype.isNumeric = function(col){
        return this.filter(function(row){
            return !isNaN(parseFloat(row[col])) && isFinite(row[col]);
        }).length > 0;
    };

    Array.prototype.rename = function(o, n){
    ...
    Array.prototype.segment = function(start, end){
    ...
    Array.prototype.fill = function(condition, fill){
        var parts, left, right, lambda, self = this;
        ...
        //     var selected = this.where.call(this, condition);
        //     this.map(function(row){ if(selected.has(row)) for(var col in row) if(row[col]==value) row[col] = fill; });
        // }
        // else{
        //     this.map(function(row){ for(var col in row) if(row[col]==value) row[col] = fill; });
        // }
    };

    Array.prototype.null = function(fill){
        return this.fill('* = null', fill);
    };

    Array.prototype.getprop = (function(prop, getter){
    ...
    Array.prototype.count = Array.prototype.getprop('count', function(){return this.length;});

    Array.prototype.delete = Array.prototype.getprop('delete', function(){
        var self = this;
        return {
            column : function(c){
    ...
    Array.prototype.where = function(left, operator, right){
        // todo: weed out '==', '&&'
        ...
        var evaluate = function(statement){
            ...
            if(typeof statement.left=='object'){
                ...
                // if(istype(left)=="Array" && left.length==1)
                //     left = left[0];
            }
            else{
                left = statement.left;
    ...
    Array.prototype.merge = function(){
        ...
        var merge = function(){
            ...
            if(join=='full' || join=='outer'){
                ...
                if(on!="index"){
                    //diffs = right.column(on).diff(left.column(on));
    ...
    Array.prototype.left = Array.prototype.getprop('left', function(){
        return new Promote(this, 'left');
    });

    Array.prototype.right = Array.prototype.getprop('right', function(){
        return new Promote(this, 'right');
    });

    Array.prototype.resolve = function(direction){
